...
public class CustomArrayListTestA5<T> {
    ...
    void testAddElementWithResize() {
        ...
        assertEquals(10, ((Object[]) getItemsField(sut, "items")).length);  // Check initial capacity

        sut.add((T) "Element 10");
        assertEquals(11, sut.getSize());
        assertEquals("Element 10", sut.get(10));
        assertEquals(20, ((Object[]) getItemsField(sut, "items")).length);  // Check new capacity after resize
    }
    ...
    private Object getItemsField(Object obj, String items) {
        try {
